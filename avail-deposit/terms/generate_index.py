          ...
          <div class="site-footer__nav-group site-footer__nav-group--pages">
            <div class="site-footer__nav-columns">
              ...
              <ul class="site-footer__nav-list site-footer__nav-list--pages-right">
                ...
                <li><a href="#" class="site-footer__nav-link" aria-current="page">T&amp;C</a></li>
...
<head>
  ...
  <title>Terms &amp; Conditions — Avail</title>
  <meta name="description" content="Terms and Conditions for Avail Mainnet." />
...
{NAV_HTML}
    ...
    <main>
      <section class="hero hero--terms">
        <div class="wrap hero--terms__inner">
          <p class="hero--terms__eyebrow">Avail Mainnet</p>
          <h1 class="hero--terms__title">Terms &amp; Conditions</h1>
        </div>
      </section>

      <section class="terms-body">
        <div class="wrap terms-body__inner">
{content}
        </div>
      </section>
    </main>
